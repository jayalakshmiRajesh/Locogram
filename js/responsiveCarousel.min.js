		...
		return e(this)
				.each(
						function() {
							...
							n.isTouch = "ontouchstart" in document.documentElement
									|| navigator.userAgent
							...
							r.init = function() {
								...
								e(r).find("." + n.imageWideClass).each(
										function() {
											e(this).css({
												display : "block",
												width : "100%",
								...
								if (n.carousel)
									e(r).find(".crsl-item:first-child")
											.addClass(n.itemClassActive);
								if (n.carousel && n.infinite
										&& n.visible < n.total)
									e(r).find(".crsl-item:first-child").before(
											e(".crsl-item:last-child", r));
								if (n.overflow === false) {
									e(r).css({
										overflow : "hidden"
									})
							...
							r.preloadImage = function(t, i, s) {
								var o = new Image, u = {};
								u.src = e(t).attr("src") !== undefined
										? t.src
										: "";
								u.alt = e(t).attr("alt") !== undefined
										? t.alt
										: "";
								e(o).attr(u);
								e(o)
										.on(
												...
												function() {
													...
													if (i === s)
														e(r)
																.trigger(
																		"loadedImagesCarousel",
																		[n, r])
												})
							};
							r.config = function() {
								n.itemWidth = Math
										.floor((e(r).outerWidth() - n.itemMargin
												* (n.visibleDefault - 1))
												/ n.visibleDefault);
								...
								if (n.carousel) {
									r.wrapWidth = Math
											.floor((n.itemWidth + n.itemMargin)
													* n.total);
									r.wrapMargin = r.wrapMarginDefault = n.infinite
											&& n.visible < n.total ? parseInt(
							...
							r.initRotate = function() {
								if (n.autoRotate !== false) {
									r.rotateTime = window.setInterval(
											function() {
												r.rotate()
											}, n.autoRotate)
								}
							...
							r.prepareExecute = function() {
								...
								r.itemActive = e(r).find(
										".crsl-item." + n.itemClassActive);
								return true
							};
							...
							r.testPrevious = function(t) {
								return e(".crsl-wrap", r).find(".crsl-item")
										.index(t) > 0
							};
							r.testNext = function() {
								return !n.infinite
										&& r.wrapWidth >= (n.itemWidth + n.itemMargin)
												* (n.visible + 1)
...
//													e(r).find('.crsl-active').click();//stephen
////													console.log(e(r).find('.crsl-active'));
...
//													t.preventDefault();
//													t.stopPropagation();
//													n.swipeDistance = n.endCoords.pageX
//															- n.startCoords.pageX;
...
//												})
//							}
							e(r).on("loadedCarousel loadedImagesCarousel",
									function() {
										r.equalHeights()
									});
												...
												e(window)
														.on(
																...
																function() {
																	...
																	this.carouselResizeTo = setTimeout(
																			function() {
																				e(
																						this)
																						.trigger(
