...
var ShareButton = (function (_ShareUtils) {
  ...
  _createClass(ShareButton, [{
    ...
    value: function _public(action) {
      ...
      if (typeof element === 'undefined') instances = _get(Object.getPrototypeOf(ShareButton.prototype), '_objToArray', this).call(this, document.querySelectorAll('share-button'));else instances = document.querySelectorAll(element);
    ...
    value: function _setup(element, opts) {
      ...
      if (typeof element === 'undefined') instances = _get(Object.getPrototypeOf(ShareButton.prototype), '_objToArray', this).call(this, document.querySelectorAll('share-button'+opts.className));else {
